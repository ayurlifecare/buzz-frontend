  ...
  const handleConfirmLocation = async () => {
    if (tempSelectedLocation && tempSelectedLatLng) {
      ...
      try {
        ...
        // Always allow confirmation — just warn if outside delivery zone
        // Users should still be able to browse products
        if (!res && !demoMode) {
          addToast({
            title: "Outside delivery zone",
            color: "warning",
            description: "Delivery may not be available at this location, but you can still browse.",
          });
        }
